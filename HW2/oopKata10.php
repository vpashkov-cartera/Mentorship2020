...
$object_oriented_php = new class()
{
    ...
    {
        $this->author = new class ('Donald', 17, 'Male', 'Computer Programmer') extends Person
        {
            public $gender;
            ...
            {
                return sprintf(
                    'Donald, aged %s, who is a %s proficient in Javascript and PHP and is a PHP enthusiast',
                    $this->age,
    ...
    {
        if (!is_int($kata_number) || !((1 <= $kata_number) && ($kata_number <= $this->kata_count))) {
